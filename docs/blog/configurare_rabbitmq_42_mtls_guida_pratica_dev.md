---
title: "RabbitMQ 4.2 mTLS e AMQP 1.0: Guida essenziale per sviluppatori"
description: "Scopri come configurare RabbitMQ 4.2 con mTLS e AMQP 1.0 in questa guida pratica per sviluppatori. Segui i passaggi dettagliati per garantire una comunicazione sicura tra i tuoi servizi."
...
categories:
  ...
  - Sviluppo
  - AMQP
slug: rabbitmq-4-2-mtls-e-amqp-1-0-guida-essenziale-per-sviluppatori
permalink: https://www.dontesta.it/2025/05/18/rabbitmq-4-1-mtls-e-amqp-1-0-guida-essenziale-per-sviluppatori/
status: published
publishdate: 2026-01-11
---

## Configurare RabbitMQ 4.2 mTLS e AMQP 1.0: Guida Pratica per Sviluppatori
...
Client certificates generated.
All certificates generated in ./certs/
Skipping Linux-specific permission adjustments on Darwin.
Checking /etc/hosts for entry '127.0.0.1 rabbitmq.labs.dontesta.it'...
/etc/hosts is OK.
Starting RabbitMQ container (rabbitmq-dev-server) with image docker.io/library/rabbitmq:4.2.2-management...
3d30b5f8ff6ed6080830384af3ea53515e027fcd3565599a5f366063960603a5
...
podman exec rabbitmq-dev-server rabbitmqadmin -u rabbit_admin -p 'SuperS3cureAdminP@ssw0rd!' -V logistics_vhost declare binding --source order_exchange --destination-type queue --destination logistics_queue --routing-key new_order_event || echo "Binding already exists or error."
Topology configured.
```
...
```plaintext
2026-01-11 13:43:47.793160+00:00 [info] <0.583.0> started TLS (SSL) listener on [::]:5671
 completed with 4 plugins.
2026-01-11 13:43:47.873504+00:00 [info] <0.440.0> Server startup complete; 4 plugins started.
2026-01-11 13:43:47.873504+00:00 [info] <0.440.0>  * rabbitmq_prometheus
2026-01-11 13:43:47.873504+00:00 [info] <0.440.0>  * rabbitmq_management
2026-01-11 13:43:47.873504+00:00 [info] <0.440.0>  * rabbitmq_management_agent
2026-01-11 13:43:47.873504+00:00 [info] <0.440.0>  * rabbitmq_web_dispatch
2026-01-11 13:43:47.873635+00:00 [debug] <0.440.0> Marking RabbitMQ as running
2026-01-11 13:43:47.873661+00:00 [debug] <0.440.0> Change boot state to `ready`
2026-01-11 13:43:47.873724+00:00 [debug] <0.145.0> Boot state/systemd: notifying of state `ready`
2026-01-11 13:43:47.956253+00:00 [info] <0.10.0> Time to start RabbitMQ: 3728 ms
...
2026-01-11 13:43:55.647754+00:00 [info] <0.631.0> Created user 'rabbit_admin'
2026-01-11 13:43:56.108418+00:00 [debug] <0.637.0> Asked to set user tags for user 'rabbit_admin' to [administrator]
2026-01-11 13:43:56.109767+00:00 [info] <0.637.0> Successfully set user tags for user 'rabbit_admin' to [administrator]
2026-01-11 13:43:56.554304+00:00 [debug] <0.643.0> Asked to set permissions for user 'rabbit_admin' in virtual host 'logistics_vhost' to '.*', '.*', '.*'
2026-01-11 13:43:56.555669+00:00 [info] <0.643.0> Successfully set permissions for user 'rabbit_admin' in virtual host 'logistics_vhost' to '.*', '.*', '.*'
2026-01-11 13:43:57.016643+00:00 [debug] <0.649.0> Asked to create a new user 'order_sender', password length in bytes: 152
2026-01-11 13:43:57.024603+00:00 [info] <0.649.0> Created user 'order_sender'
2026-01-11 13:43:57.489176+00:00 [debug] <0.655.0> Asked to create a new user 'delivery_receiver', password length in bytes: 192
2026-01-11 13:43:57.490828+00:00 [info] <0.655.0> Created user 'delivery_receiver'
2026-01-11 13:43:57.934642+00:00 [debug] <0.661.0> Asked to set permissions for user 'order_sender' in virtual host 'logistics_vhost' to '', '^order_exchange$', ''
2026-01-11 13:43:57.936398+00:00 [info] <0.661.0> Successfully set permissions for user 'order_sender' in virtual host 'logistics_vhost' to '', '^order_exchange$', ''
2026-01-11 13:43:58.351229+00:00 [debug] <0.667.0> Asked to set permissions for user 'delivery_receiver' in virtual host 'logistics_vhost' to '', '', '^logistics_queue$'
2026-01-11 13:43:58.353010+00:00 [info] <0.667.0> Successfully set permissions for user 'delivery_receiver' in virtual host 'logistics_vhost' to '', '', '^logistics_queue$'
...
2026-01-11 13:47:23.534781+00:00 [info] <0.703.0> accepting AMQP connection 10.88.0.6:50792 -> 10.88.0.6:5671
2026-01-11 13:47:23.555646+00:00 [debug] <0.703.0> User 'order_sender' authenticated successfully by backend rabbit_auth_backend_internal
2026-01-11 13:47:23.556765+00:00 [info] <0.703.0> Connection from AMQP 1.0 container 'b1bb9aa3-8938-4ed8-9b52-490b21df922b': user 'order_sender' authenticated using SASL mechanism PLAIN and granted access to vhost 'logistics_vhost'
2026-01-11 13:47:23.556848+00:00 [debug] <0.703.0> AMQP 1.0 connection.open frame: hostname = vhost:logistics_vhost, extracted vhost = logistics_vhost, idle-time-out = undefined
2026-01-11 13:47:23.561505+00:00 [debug] <0.703.0> AMQP 1.0 created session process <0.708.0> for channel number 0
2026-01-11 13:47:23.574477+00:00 [debug] <0.703.0> AMQP 1.0 closed session process <0.708.0> with channel number 0
2026-01-11 13:47:23.580657+00:00 [info] <0.703.0> closing AMQP connection (10.88.0.6:50792 -> 10.88.0.6:5671, duration: '46ms')
```
